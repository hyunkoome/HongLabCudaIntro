...
void VulkanCudaInterop::CudaUpdateVkImage() {
    ...
    copyKernel<<<dimGrid, dimBlock>>>(d_surfaceObjectList, textureObjMipMapInput, imageWidth,
                                      imageHeight);
    ...
    // blurKernel<<<dimGrid, dimBlock, 0, streamToRun>>>(d_surfaceObjectList,
    // d_surfaceObjectListTemp,
    //                                                   imageWidth, imageHeight,
    //                                                   filter_radius, boundary);

    // sobelKernel<<<dimGrid, dimBlock, 0, streamToRun>>>(d_surfaceObjectList,
    // d_surfaceObjectListTemp,
    //                                                    imageWidth, imageHeight,
    //                                                    boundary);

    // sepiaKernel<<<dimGrid, dimBlock, 0, streamToRun>>>(d_surfaceObjectList,
    // d_surfaceObjectListTemp,
    //                                                    imageWidth, imageHeight,
    //                                                    boundary);

    // hueRotationKernel<<<dimGrid, dimBlock, 0, streamToRun>>>(d_surfaceObjectList,
    // d_surfaceObjectListTemp,
    //                                                    imageWidth, imageHeight,
    //                                                    float(boundary) / WIDTH * 3.141592f);

    // embossKernel<<<dimGrid, dimBlock, 0, streamToRun>>>(
    //     d_surfaceObjectList, d_surfaceObjectListTemp,
